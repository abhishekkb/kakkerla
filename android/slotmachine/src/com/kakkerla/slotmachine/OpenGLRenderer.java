...
package com.kakkerla.slotmachine;
...
import com.kakkerla.slotmachine.R;
...
public class OpenGLRenderer implements Renderer 
{
	...
	public OpenGLRenderer(Context context, Handler handler) 
	{
		...
		// Calculate starting spinner positions randomly
		rot1 = rgen.nextInt(5) * 72;
		rot2 = rgen.nextInt(5) * 72;			
		rot3 = rgen.nextInt(5) * 72;
		...
		*/
		...
		spinner = new Spinner (0.9f, 1.0f);
		spinner.loadBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.slot_5pics_512));
				...
				//		});
						...
						mHandler.post(new Runnable() {
							...
							//	toastLayout.addView(text);   
								...
								ImageToast.setGravity(Gravity.CENTER
										, 0, 0);
								ImageToast.show();
				    			...
				    			note.flags = Notification.FLAG_AUTO_CANCEL;;//FLAG_AUTO_CANCEL;
				    			nmgr.notify(1, note); 
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			synchronized (this) {
				...
				if (spinTime == 0) {
					...
					final_rot1 = rgen.nextInt(4) * 90;
					final_rot2 = rgen.nextInt(4) * 90;			
					final_rot3 = rgen.nextInt(4) * 90;
					...
					// Calculate the final spinner positions randomly
					if(touchCounter<5){
						final_rot1 = rgen.nextInt(5) * 72;
						final_rot2 = rgen.nextInt(5) * 72;			
						final_rot3 = rgen.nextInt(5) * 72;
					}else{
						touchCounter = 0;
						final_rot1 = rgen.nextInt(5) * 72;
						final_rot2 = final_rot1; // force a win
